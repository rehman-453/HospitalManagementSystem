                ...
                <div class="row">
                    <form method="post" action="operation.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="complain" class="form-control" rows="5" placeholder="Type your Complain..."></textarea>
                        </div>
                        <div class="form-group col-md-6">
                            <br>
                            <br>
                            <br>
                            <br>
                            <button class="btn btn-success " name="btn_complain"> 
                ...
                <div class="row">
                    <table style="width:100%" border="1" class="table table-striped"  >
                        <tr>
                            ...
                            <th class="bg-primary">Complain</th>
                            <th class="bg-primary" style="text-align: center;">Date</th>
                        </tr>

                        <?php
                            $sql = "SELECT * FROM tbl_complain WHERE patient_id = '".$_SESSION['user_id']."' ORDER BY complain_id DESC";
